...
Revision ID: 137b0fe2b99c
Revises: 
Create Date: 2019-04-28 11:43:35.404006
...
def upgrade():
    ...
    op.create_table('ks_facility_info',
    sa.Column('create_time', sa.DateTime(), nullable=True),
    sa.Column('update_time', sa.DateTime(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=32), nullable=False),
    ...
    op.create_table('ks_user_profile',
    sa.Column('create_time', sa.DateTime(), nullable=True),
    sa.Column('update_time', sa.DateTime(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=32), nullable=False),
    ...
    sa.ForeignKeyConstraint(['area_id'], ['ks_area_info.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['ks_user_profile.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('ks_house_facility',
    sa.Column('house_id', sa.Integer(), nullable=False),
    sa.Column('facility_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['facility_id'], ['ks_facility_info.id'], ),
    sa.ForeignKeyConstraint(['house_id'], ['ks_house_info.id'], ),
    sa.PrimaryKeyConstraint('house_id', 'facility_id')
    )
    op.create_table('ks_house_image',
    sa.Column('create_time', sa.DateTime(), nullable=True),
    sa.Column('update_time', sa.DateTime(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('house_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_ks_order_info_status'), 'ks_order_info', ['status'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_ks_order_info_status'), table_name='ks_order_info')
    op.drop_table('ks_order_info')
    op.drop_table('ks_house_image')
    op.drop_table('ks_house_facility')
    op.drop_table('ks_house_info')
    op.drop_table('ks_user_profile')
    op.drop_table('ks_facility_info')
    op.drop_table('ks_area_info')
    # ### end Alembic commands ###
