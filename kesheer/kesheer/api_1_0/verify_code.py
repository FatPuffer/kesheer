...
# GET /api/v1.0/sms_codes/<modile>?image_code=xxxx&image_code_id=xxxx
...
def get_sms_code(mobile):
    ...
    # 对该手机操作进行判断，判断其在60s内有没有之前的记录，如果有，则认为用户频繁操作，不接受处理
    try:
    ...
    try:
        ...
        # 保存发送给这个手机号的记录，防止用户在60s之内重复发送短信
        # 如果有1这个值，说明在60s内我有给你发送过验证码
