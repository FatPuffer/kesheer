...
from kesheer.models import Order
from kesheer.utils.response_code import RET
from kesheer import constants, db
...
def save_order_payment_result():
    ...
    # to_dict():自带方法，将对象转换为字典格式
    alipay_dict = request.form.to_dict()

    # 对支付宝数据进行分离操作，提取出支付宝签名参数sign，和剩下的其他数据
    ...
    return jsonify(errno=RET.OK, errmdg='OK')
