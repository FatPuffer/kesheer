...
import string
import os.path
# from cStringIO import StringIO  # python2 写法
from io import BytesIO

from PIL import Image  # python3需要安装pillow模块，才可以使用PIL
...
class Captcha(object):
    ...
    def initialize(self, width=200, height=75, color=None, text=None, fonts=None):
        ...
        # string.uppercase、string.uppercase   python2写法
    ...
    def captcha(self, path=None, fmt='JPEG'):
        ...
        # python2写法string.lowercase、string.uppercase
